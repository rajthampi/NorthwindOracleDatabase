...
--------------------------------------------------------
  ...
  CREATE TABLE "CATEGORIES" 
   (	"CATEGORYID" NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 9 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "EMPLOYEES" 
   (	"EMPLOYEEID" NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 10 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "ORDERS" 
   (	"ORDERID" NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 11078 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"CUSTOMERID" NCHAR(5), 
	"EMPLOYEEID" NUMBER(10,0), 
	"ORDERDATE" DATE, 
	"REQUIREDDATE" DATE, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "PRODUCTS" 
   (	"PRODUCTID" NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 78 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SHIPPERS" 
   (	"SHIPPERID" NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 4 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"COMPANYNAME" NVARCHAR2(40), 
	"PHONE" NVARCHAR2(24)
   ) ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SUPPLIERS" 
   (	"SUPPLIERID" NUMBER(10,0) GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 30 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"COMPANYNAME" NVARCHAR2(40), 
	"CONTACTNAME" NVARCHAR2(30), 
	"CONTACTTITLE" NVARCHAR2(30), 
	"ADDRESS" NVARCHAR2(60), 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ALPHABETICAL_LIST_OF_PRODUCTS" ("PRODUCTID", "PRODUCTNAME", "SUPPLIERID", "CATEGORYID", "QUANTITYPERUNIT", "UNITPRICE", "UNITSINSTOCK", "UNITSONORDER", "REORDERLEVEL", "DISCONTINUED", "CATEGORYNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CATEGORY_SALES_FOR_1997" ("CATEGORYNAME", "CATEGORYSALES") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CURRENT_PRODUCT_LIST" ("PRODUCTID", "PRODUCTNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CUSTOMER_AND_SUPPLIERS_BY_CITY" ("CITY", "COMPANYNAME", "CONTACTNAME", "RELATIONSHIP") AS 
  SELECT City ,
          CompanyName ,
          ContactName ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ORDERS_QRY" ("ORDERID", "CUSTOMERID", "EMPLOYEEID", "ORDERDATE", "REQUIREDDATE", "SHIPPEDDATE", "SHIPVIA", "FREIGHT", "SHIPNAME", "SHIPADDRESS", "SHIPCITY", "SHIPREGION", "SHIPPOSTALCODE", "SHIPCOUNTRY", "COMPANYNAME", "ADDRESS", "CITY", "REGION", "POSTALCODE", "COUNTRY") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ORDER_DETAILS_EXTENDED" ("ORDERID", "PRODUCTID", "PRODUCTNAME", "UNITPRICE", "QUANTITY", "DISCOUNT", "EXTENDEDPRICE") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ORDER_SUBTOTALS" ("ORDERID", "SUBTOTAL") AS 
  SELECT Order_Details.OrderID ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PRODUCTS_ABOVE_AVERAGE_PRICE" ("PRODUCTNAME", "UNITPRICE") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PRODUCTS_BY_CATEGORY" ("CATEGORYNAME", "PRODUCTNAME", "QUANTITYPERUNIT", "UNITSINSTOCK", "DISCONTINUED") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PRODUCT_SALES_FOR_1997" ("CATEGORYNAME", "PRODUCTNAME", "PRODUCTSALES") AS 
  SELECT Categories.CategoryName ,
          Products.ProductName ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "QUARTERLY_ORDERS" ("CUSTOMERID", "COMPANYNAME", "CITY", "COUNTRY") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SALES_BY_CATEGORY" ("CATEGORYID", "CATEGORYNAME", "PRODUCTNAME", "PRODUCTSALES") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SALES_TOTALS_BY_AMOUNT" ("SALEAMOUNT", "ORDERID", "COMPANYNAME", "SHIPPEDDATE") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SUMMARY_OF_SALES_BY_QUARTER" ("SHIPPEDDATE", "ORDERID", "SUBTOTAL") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "SUMMARY_OF_SALES_BY_YEAR" ("SHIPPEDDATE", "ORDERID", "SUBTOTAL") AS 
  SELECT Orders.ShippedDate ,
          Orders.OrderID ,
          Order_Subtotals.Subtotal 
     FROM Orders 
...
SET DEFINE OFF;
Insert into EMPLOYEES (EMPLOYEEID,LASTNAME,FIRSTNAME,TITLE,TITLEOFCOURTESY,BIRTHDATE,HIREDATE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,HOMEPHONE,EXTENSION,REPORTSTO,PHOTOPATH) values (1,'Davolio','Nancy','Sales Representative','Ms.',to_date('08-DEC-48','DD-MON-RR'),to_date('01-MAY-92','DD-MON-RR'),'507 - 20th Ave. E.
...
Insert into EMPLOYEES (EMPLOYEEID,LASTNAME,FIRSTNAME,TITLE,TITLEOFCOURTESY,BIRTHDATE,HIREDATE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,HOMEPHONE,EXTENSION,REPORTSTO,PHOTOPATH) values (6,'Suyama','Michael','Sales Representative','Mr.',to_date('02-JUL-63','DD-MON-RR'),to_date('17-OCT-93','DD-MON-RR'),'Coventry House
Miner Rd.','London',null,'EC2 7JR','UK','(71) 555-7773','428',5,'http://accweb/emmployees/davolio.bmp');
Insert into EMPLOYEES (EMPLOYEEID,LASTNAME,FIRSTNAME,TITLE,TITLEOFCOURTESY,BIRTHDATE,HIREDATE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,HOMEPHONE,EXTENSION,REPORTSTO,PHOTOPATH) values (7,'King','Robert','Sales Representative','Mr.',to_date('29-MAY-60','DD-MON-RR'),to_date('02-JAN-94','DD-MON-RR'),'Edgeham Hollow
...
SET DEFINE OFF;
Insert into SUPPLIERS (SUPPLIERID,COMPANYNAME,CONTACTNAME,CONTACTTITLE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,PHONE,FAX) values (28,'Gai pâturage','Eliane Noz','Sales Representative','Bat. B 3, rue des Alpes','Annecy',null,'74000','France','38.76.98.06','38.76.98.58');
Insert into SUPPLIERS (SUPPLIERID,COMPANYNAME,CONTACTNAME,CONTACTTITLE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,PHONE,FAX) values (29,'Forêts d''érables','Chantal Goulet','Accounting Manager','148 rue Chasseur','Ste-Hyacinthe','Québec','J2S 7S8','Canada','(514) 555-2955','(514) 555-2921');
...
Insert into SUPPLIERS (SUPPLIERID,COMPANYNAME,CONTACTNAME,CONTACTTITLE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,PHONE,FAX) values (9,'PB Knäckebröd AB','Lars Peterson','Sales Agent','Kaloadagatan 13','Göteborg',null,'S-345 67','Sweden','031-987 65 43','031-987 65 91');
...
Insert into SUPPLIERS (SUPPLIERID,COMPANYNAME,CONTACTNAME,CONTACTTITLE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,PHONE,FAX) values (11,'Heli Süßwaren GmbH & Co. KG','Petra Winkler','Sales Manager','Tiergartenstraße 5','Berlin',null,'10785','Germany','(010) 9984510',null);
Insert into SUPPLIERS (SUPPLIERID,COMPANYNAME,CONTACTNAME,CONTACTTITLE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,PHONE,FAX) values (12,'Plutzer Lebensmittelgroßmärkte AG','Martin Bein','International Marketing Mgr.','Bogenallee 51','Frankfurt',null,'60439','Germany','(069) 992755',null);
...
Insert into SUPPLIERS (SUPPLIERID,COMPANYNAME,CONTACTNAME,CONTACTTITLE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,PHONE,FAX) values (17,'Svensk Sjöföda AB','Michael Björn','Sales Representative','Brovallavägen 231','Stockholm',null,'S-123 45','Sweden','08-123 45 67',null);
Insert into SUPPLIERS (SUPPLIERID,COMPANYNAME,CONTACTNAME,CONTACTTITLE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,PHONE,FAX) values (18,'Aux joyeux ecclésiastiques','Guylène Nodier','Sales Manager','203, Rue des Francs-Bourgeois','Paris',null,'75004','France','(1) 03.83.00.68','(1) 03.83.00.62');
...
Insert into SUPPLIERS (SUPPLIERID,COMPANYNAME,CONTACTNAME,CONTACTTITLE,ADDRESS,CITY,REGION,POSTALCODE,COUNTRY,PHONE,FAX) values (25,'Ma Maison','Jean-Guy Lauzon','Marketing Manager','2960 Rue St. Laurent','Montréal','Québec','H1J 1C3','Canada','(514) 555-9022',null);
...
--------------------------------------------------------
  ...
  CREATE INDEX "PRODUCTSORDER_DETAILS_1" ON "ORDER_DETAILS" ("PRODUCTID") 
  ;
--------------------------------------------------------
--  DDL for Index CATEGORYID_1
--------------------------------------------------------

  CREATE INDEX "CATEGORYID_1" ON "PRODUCTS" ("CATEGORYID") 
  ;
--------------------------------------------------------
--  DDL for Index SUPPLIERSPRODUCTS_1
--------------------------------------------------------

  CREATE INDEX "SUPPLIERSPRODUCTS_1" ON "PRODUCTS" ("SUPPLIERID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "EMPLOYEESORDERS_1" ON "ORDERS" ("EMPLOYEEID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "POSTALCODE_1" ON "CUSTOMERS" ("POSTALCODE") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PK_ORDER_DETAILS" ON "ORDER_DETAILS" ("ORDERID", "PRODUCTID") 
  ;
--------------------------------------------------------
--  DDL for Index ORDERSORDER_DETAILS_1
--------------------------------------------------------

  CREATE INDEX "ORDERSORDER_DETAILS_1" ON "ORDER_DETAILS" ("ORDERID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "CUSTOMERSORDERS_1" ON "ORDERS" ("CUSTOMERID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "CK_BIRTHDATE_SYSDTRG" 
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "CLOBTOBLOB_SQLDEVELOPER" 
  ( 
    tableNameL      VARCHAR2 , 
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "CUSTORDERHIST" 
(
  v_CustomerID IN NCHAR
)
AS
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "CUSTORDERSDETAIL" 
(
  v_OrderID IN NUMBER
)
AS
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "CUSTORDERSORDERS" 
(
  v_CustomerID IN NCHAR
)
AS
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "EMPLOYEE_SALES_BY_COUNTRY" 
(
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "SALESBYCATEGORY" 
(
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "SALES_BY_YEAR" 
(
  v_Beginning_Date IN DATE,
  v_Ending_Date IN DATE
)
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "TEN_MOST_EXPENSIVE_PRODUCTS" 
AS
   v_cursor SYS_REFCURSOR;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE SYNONYM "UTILS" FOR "UTILS";
--------------------------------------------------------
